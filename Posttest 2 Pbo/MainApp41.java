...
public class MainApp41 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (pilihan) {
                case 1: servis.tambahWarga(); break;
                case 2: servis.tampilkanWarga(); break;
                case 3: servis.updateWarga(); break;
                case 4: servis.hapusWarga(); break;
                case 5: servis.cariWarga(); break;
